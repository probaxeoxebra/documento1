...
O que pasa é que hai moitas "versións" de Markdown e hai que seguir a que entenda o teu sistema. Polo que parece GitHub utiliza kramdown que ten unha documentación en [Quick Reference](https://kramdown.gettalong.org/quickref.html).

A documentación oficial de GitHub de Markdown para o seu uso é [Writing on GitHub](https://help.github.com/categories/writing-on-github/).
